...
// Pencarian Mahasiswa
$keywordMhs = isset($_GET['keyword_mhs']) ? $_GET['keyword_mhs'] : '';
$queryMhs = "SELECT * FROM t_mahasiswa WHERE namaMhs LIKE '%$keywordMhs%'";
$resultMhs = mysqli_query($link, $queryMhs);

// Pencarian Mata Kuliah
$keywordMK = isset($_GET['keyword_mk']) ? $_GET['keyword_mk'] : '';
$queryMK = "SELECT * FROM t_matakuliah WHERE namaMK LIKE '%$keywordMK%'";
$resultMK = mysqli_query($link, $queryMK);

// Pencarian Dosen
$keywordDosen = isset($_GET['keyword_dosen']) ? $_GET['keyword_dosen'] : '';
$queryDosen = "SELECT * FROM t_dosen WHERE namaDosen LIKE '%$keywordDosen%'";
$resultDosen = mysqli_query($link, $queryDosen);
?>
